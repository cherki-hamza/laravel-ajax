            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item mr-4">
                            <a class="nav-link text-danger font-weight-bold" href="{{route('course')}}"><i class="fa fa-dragon mr-2"></i>{{ __('Course') }}</a>
                        </li>
                        <li class="nav-item mr-4">
                            <a class="nav-link text-primary font-weight-bold" href="#"><i class="fa fa-user-injured mr-2"></i>{{ __('Dashboard') }}</a>
                        </li>
